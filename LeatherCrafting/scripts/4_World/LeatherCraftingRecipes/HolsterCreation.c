class SitchChestHolster extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Sitch Chest Holster";
		...
		m_MinQuantityIngredient[1] = 19;//-1 = disable check
		...
		//result1
		AddResult("HandMadeChestHolster");//add results here
...
class SitchPistolHolster extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Sitch Pistol Holster";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("LeatherSewedHolster");//add results here
...
class SitchSawedOffHolster extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Sitch Sawed off Holster";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("LeatherSawnedOffHolster");//add results here
