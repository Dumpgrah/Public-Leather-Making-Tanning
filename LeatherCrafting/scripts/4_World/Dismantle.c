class DismantleFrame extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Take Apart";
		...
		//ingredient 2
		InsertIngredient(1,"DryingFrame");//you can insert multiple ingredients this way
		...
		m_ResultSetHealth[1] = 100;//-1 = do nothing
		...
		m_ResultSetHealth[2] = 50;//-1 = do nothing
		...
		m_ResultSetQuantity[3] = 4;//-1 = do nothing
	...
	override bool CanDo(ItemBase ingredients[], PlayerBase player)//final check for recipe's validity
	{
		...
		if ( ingredient1.GetAttachmentByType ( CleanedPelt_Base ) || ingredient1.GetAttachmentByType ( GardenLime ) || ingredient1.GetAttachmentByType (TannedLeather) )
		{
			return false;
		}
		return true;
